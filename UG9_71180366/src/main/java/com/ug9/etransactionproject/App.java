...
public class App 
{
    public static void main( String[] args ) {
        com.ug9.eTransactionProject.DigitalPayment angelBRI = new BRImo("Angel",5000000,"250071190490");
        com.ug9.eTransactionProject.DigitalPayment felixBNI = new BNImo("Felix",2500000,"250071190494");
        com.ug9.eTransactionProject.DigitalPayment joyceBRI = new BRImo("Joyce",1500000,"250071190495");
        com.ug9.eTransactionProject.DigitalPayment oliveDana = new Dana("Olive",0,"081234567891");
        com.ug9.eTransactionProject.DigitalPayment adrianOvo = new Ovo("Adrian",150000,"081578961543");
        com.ug9.eTransactionProject.DigitalPayment nolaDana = new Dana("Nola",550000,"081734566789");
    ...
    public static void printSaldo(com.ug9.eTransactionProject.DigitalPayment dp){
