...
public class App
{
    ...
    private static final ArrayList<Goods> goods = new ArrayList<Goods>();
    ...
    private static final ArrayList<Double> acceptanceBalance = new ArrayList<Double>();
    private static final ArrayList<String> goodsOrderCode = new ArrayList<String>();
